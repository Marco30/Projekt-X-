...
var DateAndTime =
    {
        start: function () {
          ...
          //fixar menyn i elcetion view när det är mobil CSS
                //$('.knapptextCandidate').addClass('knapptextCandidateSmal').removeClass('knapptextCandidate');
                //$('.btn.btn-default').find('.knapptext').addClass('knapptextV').removeClass('knapptext');
                //$('.btn.btn-info').find('.knapptext').addClass('knapptextB').removeClass('knapptext');
                $('.knapptextCandidate').attr('class', 'knapptextCandidateSmal');
                //alert('Less than 960');
            }
            else {
